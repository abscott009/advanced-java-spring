...
public class CodingNomadConfiguration {
    ...
    @Bean
    public Computer computer() {return Computer.builder().brand("Mac").model("MacBook Pro").build();}

    @Bean
    public OperatingSystem operatingSystem() {return OperatingSystem.builder().os("Ventura").version("13.2").build();}
}
